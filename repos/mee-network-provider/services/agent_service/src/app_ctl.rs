use crate::{config::AppConfig, error::AgentServiceResult};
use axum::Router;
use clap::Parser;
...
use provider_authority_secrets::ProviderAuthoritySignatureServiceDefault;
use std::sync::Arc;
...
impl AppCtl {
    pub async fn try_new() -> AgentServiceResult<Self> {
        ...
        let provider_authority_signature =
            Arc::new(ProviderAuthoritySignatureServiceDefault::new(
